...
export const torqueData = [
    ...
    },
    {
        ...
        items: [
            { size: 'M3.5', torque_nm: 1.0, range_nm: '0.8 ~ 1.2', note: '電磁接触器操作回路等' },
            { size: 'M4', torque_nm: 1.5, range_nm: '1.2 ~ 1.8', note: '小容量ブレーカー等' },
            { size: 'M5', torque_nm: 2.5, range_nm: '2.0 ~ 3.0', note: '' },
            { size: 'M6', torque_nm: 4.5, range_nm: '4.0 ~ 5.0', note: '' },
            { size: 'M8', torque_nm: 9.0, range_nm: '8.0 ~ 10.0', note: '中容量ブレーカー主回路' },
            {
                size: 'M10',
                torque_nm: 18.0,
                range_nm: '15.0 ~ 20.0',
    ...
    },
    {
        ...
        items: [
            { size: 'M6', torque_nm: 5.5, range_nm: '4.5 ~ 6.5', note: '平座金＋ばね座金' },
            { size: 'M8', torque_nm: 13.0, range_nm: '11.0 ~ 15.0', note: '平座金＋ばね座金' },
            { size: 'M10', torque_nm: 25.0, range_nm: '20.0 ~ 30.0', note: '平座金＋ばね座金' },
            { size: 'M12', torque_nm: 45.0, range_nm: '40.0 ~ 50.0', note: '平座金＋ばね座金' },
            { size: 'M16', torque_nm: 110.0, range_nm: '95.0 ~ 125.0', note: '平座金＋ばね座金' }
        ]
    }
];
