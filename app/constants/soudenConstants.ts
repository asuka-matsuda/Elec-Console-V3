...
export const PHASE1_TABLE_COLUMNS: TableColumn<CircuitItem>[] = [
  ...
  { key: 'p1Kakunin', label: '確認 / 増締め', sortable: true, width: '115px', fixedWidth: true, align: 'center' },
  { key: 'p1Remarks', label: '備考', sortable: true, width: '180px', fixedWidth: true },
  { key: 'actions', label: '操作', width: '125px', fixedWidth: true, align: 'center' },
  { key: 'p1ConfirmedAt', label: '測定者 / 日時', sortable: true, width: '115px', fixedWidth: true, align: 'center' },
]
...
export const PHASE2_TABLE_COLUMNS: TableColumn<CircuitItem>[] = [
  ...
  { key: 'zetsuenS', label: '測定2', sortable: true, width: '100px', fixedWidth: true, align: 'center' },
  { key: 'zetsuenT', label: '測定3', sortable: true, width: '100px', fixedWidth: true, align: 'center' },
  { key: 'p2Remarks', label: '備考', sortable: true, width: '180px', fixedWidth: true },
  { key: 'actions', label: '操作', width: '125px', fixedWidth: true, align: 'center' },
  { key: 'p2ConfirmedAt', label: '測定者 / 日時', sortable: true, width: '110px', fixedWidth: true, align: 'center' },
]
...
export const PHASE3_TABLE_COLUMNS: TableColumn<CircuitItem>[] = [
  ...
  { key: 'denatsuSt', label: '電圧2', sortable: true, width: '75px', fixedWidth: true, align: 'center' },
  { key: 'denatsuRt', label: '電圧3', sortable: true, width: '75px', fixedWidth: true, align: 'center' },
  { key: 'kensou', label: '検相 / 点灯', sortable: true, width: '100px', fixedWidth: true, align: 'center' },
  { key: 'p3Remarks', label: '備考', sortable: true, width: '180px', fixedWidth: true },
  { key: 'actions', label: '操作', width: '125px', fixedWidth: true, align: 'center' },
  { key: 'p3ConfirmedAt', label: '測定者 / 日時', sortable: true, width: '115px', fixedWidth: true, align: 'center' },
]
