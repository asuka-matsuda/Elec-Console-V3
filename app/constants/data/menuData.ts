    ...
    items: [
      {
        ...
        href: '/portal',
        icon: 'users',
        customClass: 'c-global-nav__link--management',
    ...
    items: [
      {
        ...
        href: '/tools/voltage',
        icon: 'zap',
        customClass: 'c-global-nav__link--tool',
    ...
    items: [
      {
        ...
        icon: 'book',
        customClass: 'c-global-nav__link--database',
    ...
    items: [
      {
        ...
        icon: 'book-open',
        customClass: 'c-global-nav__link--reference',
