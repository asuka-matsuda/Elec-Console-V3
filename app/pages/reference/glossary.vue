...
<template>
  <div class="p-glossary">
    <AppFilterLayout>
      ...
      <template #main>
        <div class="p-glossary__list" v-if="filteredGlossary.length > 0">
          <AppCard
          ...
          >
            ...
            <div class="p-glossary__card-body">
              ...
              <div class="p-glossary__card-meta" v-if="item.related">
                <span class="p-glossary__card-label">関連用語</span>
                <p class="p-glossary__card-text">{{ item.related }}</p>
              </div>
              
              <div class="p-glossary__card-meta" v-if="item.example">
