...
.c-toggle {
  ...
  &__input {
    ...
    &:checked + .c-toggle__track {
      ...
      box-shadow: 0 0 10px theme-color(var(--toggle-color), 60%),
      ...
      .c-toggle__thumb {
        ...
        box-shadow: 0 0 12px var(--toggle-color), 
  ...
  &__thumb {
    ...
    transition: transform var(--duration-base) var(--ease-float),
  ...
  &:hover:not(.is-disabled) {
    .c-toggle__input:not(:focus-visible):not(:active) + .c-toggle__track {
      ...
      box-shadow: 0 0 8px theme-color(var(--toggle-color), 40%),
