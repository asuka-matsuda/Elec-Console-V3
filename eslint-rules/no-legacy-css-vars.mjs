...
const LEGACY_VARS = {
  ...
  '--radius-sm': '角丸撲滅規約（直角統一）により廃止されました。プロパティごと削除するか、真円の場合は --radius-circle を使用してください',
  '--radius-md': '角丸撲滅規約（直角統一）により廃止されました。プロパティごと削除してください',
  '--radius-lg': '角丸撲滅規約（直角統一）により廃止されました。プロパティごと削除してください',
  '--radius-full': '角丸撲滅規約（直角統一）により廃止されました。真円の場合は --radius-circle を使用してください',
  '--radius-base': '角丸撲滅規約（直角統一）により廃止されました',
  '--radius-xs': '角丸撲滅規約（直角統一）により廃止されました',
  '--font-sans': '--font-base',
