...
import PortalAtomsKairoSymbol from '../../../app/components/portal/AtomsKairoSymbol.vue'

describe('PortalAtomsKairoSymbol.vue', () => {
  it('renders circle path when kigou is "丸" or "○"', () => {
    const wrapper = mount(PortalAtomsKairoSymbol, {
