...
import MoleculesUserListItem from '../../../app/components/portal/MoleculesUserListItem.vue'
import type { User } from '../../../app/types/auth'

describe('MoleculesUserListItem.vue', () => {
  ...
  it('renders user name, loginId, and role badge', () => {
    const wrapper = mount(MoleculesUserListItem, {
      props: {
        user: dummyUser,
        isSelected: false,
      },
