...
import SoudenCircuitTable from '../../../app/components/portal/organisms/SoudenCircuitTable.vue'
import type { TableColumn } from '../../../app/types/components'
import type { CircuitItem } from '../../../app/types/souden'

describe('SoudenCircuitTable.vue', () => {
  ...
  it('回路番号と回路名称がデフォルトで正しく描画されること', () => {
    const wrapper = mount(SoudenCircuitTable, {
      props: {
