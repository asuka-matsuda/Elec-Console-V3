...
import ModalCalendarTypeSettings from '../../../app/components/portal/calendar/ModalCalendarTypeSettings.vue'

describe('ModalCalendarTypeSettings.vue', () => {
  ...
  it('renders correctly with given event types', () => {
    const wrapper = mount(ModalCalendarTypeSettings, {
      props: {
        modelValue: true,
